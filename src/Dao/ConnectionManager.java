...
/**
 * Use Dao.ConnectionManager to connect to your database instance.
 *
 * Dao.ConnectionManager uses the MySQL Connector/J driver to connect to your local MySQL instance.
 *
 * In our example, we will create a DAO (data access object) java class to interact with each MySQL
 * table. The DAO java classes will use Dao.ConnectionManager to open and close connections.
 *
...
public class ConnectionManager {
  ...
  private final String schema = "talkiemovieteam";
